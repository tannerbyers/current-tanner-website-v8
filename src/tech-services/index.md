...
Tools, guides, and content to help you build better software. Learn more about [my background and experience](/about/) or explore [detailed walkthroughs on my blog](/posts/).
...
<div style="display: grid; gap: 0.75rem; margin: 1.5rem 0;">
  ...
  <div style="padding: 0.75rem 1rem; background: rgba(255, 152, 0, 0.1); border-radius: 4px;">Test automation and accessibility</div>
</div>
